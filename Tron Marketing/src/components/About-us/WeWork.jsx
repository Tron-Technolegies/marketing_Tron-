    ...
    <section className=" bg-white flex justify-center items-center ">
      <div className="relative max-w-[942px] w-full rounded-lg overflow-hidden">
        ...
        <div className="absolute top-1/2 right-4 transform -translate-y-1/2 text-right max-w-[70%] md:max-w-[40%]">
          <h2 className="text-xl md:text-2xl font-bold text-gray-900">We Work</h2>
          <p className="text-sm md:text-base text-gray-700 mt-2 break-words leading-snug">
            How has our relationship with <br className="block md:hidden" /> work changed?
          </p>
          <button className="bg-blue-600 hover:bg-blue-700 text-white font-medium mt-4 py-2 px-4 rounded">
